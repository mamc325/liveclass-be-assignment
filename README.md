...
| **JaCoCo 등 커버리지 도구** |  핵심 불변식 검증을 우선 (총 121개 테스트 작성) |
...
> **추가 제출물**(API 명세/샘플, DB 스키마/ERD 설명)은 아래 표에서 표기된 두 문서로 갈음합니다.

| 문서 | 내용 | 비고 |
|---|---|---|
| [`docs/API.md`](docs/API.md) | API 인터페이스 명세 + 요청/응답 샘플 + 에러 형식 | **추가 제출물** |
| [`docs/ERD.md`](docs/ERD.md) | DB 스키마 / 데이터 모델 / 제약 / 인덱스 설명 | **추가 제출물** |
