...
- JSON 키 규칙: **camelCase**
- 식별자(ID): `Long` (양의 정수)
- 시간/날짜: ISO 8601 (UTC 기준, 예: `2026-05-20T14:30:00Z`)
- 날짜만 사용하는 필드: ISO 8601 date (예: `2026-06-01`)
- 서버는 모든 timestamp를 UTC 기준으로 저장하고 응답한다 (DB 컬럼은 `TIMESTAMPTZ`)
- 화폐: 원화(KRW) 정수 (`Long`)
...
```json
{
  ...
  "userId": 5,
  "status": "CONFIRMED",
  "confirmedAt": "2026-05-20T17:00:00Z",
  "promotedFromWaitlistId": null,
  "createdAt": "2026-05-20T16:00:00Z"
}
```
...
```json
{
  "enrollment": {
    "id": 100,
    "status": "CANCELLED",
    "cancelledAt": "2026-05-20T18:00:00Z"
  },
  "promoted": {
    "enrollmentId": 101,
    "fromWaitlistId": 50,
...
```json
{
  "id": 50,
  "status": "CANCELLED",
  "cancelledAt": "2026-05-20T18:30:00Z"
}
```
